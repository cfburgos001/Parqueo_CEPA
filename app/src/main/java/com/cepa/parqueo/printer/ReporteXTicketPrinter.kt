...
/**
 * Printer Manager para Ticket de REPORTE X
 * Similar al cierre, pero indica que NO cierra la caja
 */
@SuppressLint("MissingPermission")
object ReporteXTicketPrinter {
    ...
    fun printReporteX(context: Context, data: CierreTicketData) {
        ...
        try {
            ...
            Toast.makeText(context, "✓ Reporte X impreso", Toast.LENGTH_SHORT).show()
    ...
    private fun sendEscPosPrint(out: OutputStream, data: CierreTicketData) {
        ...
        out.write("*** REPORTE X ***\n".utf8())
        out.write("LA CAJA PERMANECE ABIERTA\n".utf8())
        out.write(byteArrayOf(0x1B, 0x45, 0x00))
        out.write("================================\n".utf8())
    ...
    private fun buildTicketText(data: CierreTicketData): String {
        ...
        return buildString {
            ...
            appendLine("================================")
            appendLine("*** REPORTE X ***")
            appendLine("LA CAJA PERMANECE ABIERTA")
            appendLine("================================")
        }
    }
